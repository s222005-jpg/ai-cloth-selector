...
```bash
git remote add encore encore://ai-cloth-selector-pywi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/ai-cloth-selector-pywi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/ai-cloth-selector-pywi/settings/integrations/github)
